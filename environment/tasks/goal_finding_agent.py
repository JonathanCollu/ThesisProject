...
def get_config(mode=None):
  ...
  shared_factors = distribs.Product([
      ...
      distribs.Discrete('shape', ['circle', 'triangle', 'square']),
  ...
  target_sprite_gen = sprite_generators.generate_sprites(
      shared_factors, num_sprites=1)
  distractor_sprite_gen = sprite_generators.generate_sprites(
      shared_factors, num_sprites=NUM_DISTRACTORS)
  ...
  task = tasks.FindGoalPositionInteractive(goal_sprite=-1, terminate_distance=TERMINATE_DISTANCE, obstacles=True)
